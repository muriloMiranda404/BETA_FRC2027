// Adapted from FRC 6328 (Mechanical Advantage) — org.littletonrobotics.frc2026.util.geometry.GeomUtil
...
public class GeomUtil {
  ...
  public static Twist2d toTwist2d(ChassisSpeeds speeds, double dtSeconds) {
    return new Twist2d(
