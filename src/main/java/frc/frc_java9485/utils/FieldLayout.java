...
public class FieldLayout {
	...
	public static boolean isPoseOnRobotAlliance(Pose2d pose) {
		return isPoseOnRobotAlliance(pose, DriverStation.getAlliance().get() == Alliance.Red);
	}
	...
	public static boolean isAprilTagOnRobotAlliance(AprilTag tag) {
		return isAprilTagOnRedAlliance(tag, DriverStation.getAlliance().get() == Alliance.Red);
	}
